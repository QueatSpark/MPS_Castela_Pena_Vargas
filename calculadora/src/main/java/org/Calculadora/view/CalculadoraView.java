...
public class CalculadoraView extends JFrame {
    ...
    private static final Color COLOR_INDICADOR   = new Color(0xFF, 0x4C, 0x4C); // rojo para "M"
    ...
    private JButton botonMemoriaMas, botonMemoriaMenos, botonMRC;
    ...
    public CalculadoraView() {
        ...
        indicadorMemoria.setVisible(false); // oculto por defecto
        ...
        colocar(panelBotones, gbc, botonMemoriaMas, 2, 0, 1, 1);
        colocar(panelBotones, gbc, botonMemoriaMenos, 3, 0, 1, 1);
        ...
        botonMRC = crearBotonFuncion("MRC");
        colocar(panelBotones, gbc, botonMRC, 4, 1, 1, 1);
    ...
    public void setIndicadorMemoria(boolean activo) {
        indicadorMemoria.setVisible(activo);
    }
    ...
    public JButton getBotonMRC() { return botonMRC; }
